...
$server6 = 'https://databasegdriveplayer.co/player.php?type=series&tmdb='.$tmdb.'&season='.$season.'&episode='.$episode.''; 
$server7 = 'https://v2.vidsrc.me/embed/'.$imdb.'/'.$season.'-'.$episode.'/';
?>
<!DOCTYPE html>
<html>
	<head>
	...
	<body>
			...
			<div class="videocontent">
				<div id="list-server-more">
					...
					<ul class="list-server-items">
						...
						<li onclick="loadServer(s.Server3)">dbgo.fun</li>
						<li onclick="loadServer(s.Server4)">nontongo</li>
						<li onclick="loadServer(s.Server5)">apimdb</li>
						<li onclick="loadServer(s.Server6)">gdriveplayer</li>
						<li onclick="loadServer(s.Server7)">vidsrc</li>
					</ul>
				</div>
				<div id="load-iframe">
		...
		<script>
			var s = {"Server1":"<?php echo $server1; ?>","Server2":"<?php echo $server2; ?>","Server3":"<?php echo $server3; ?>","Server4":"<?php echo $server4; ?>","Server5":"<?php echo $server5; ?>","Server6":"<?php echo $server6; ?>","Server7":"<?php echo $server7; ?>"};
		</script>
	</body>
</html>
<?php
