...
function SingleTrailer() {
	...
	if ($trailer == '') {
		...
		echo '<li id="trailer"><a id="hover" href="'.esc_url('http://www.youtube.com/watch?v='.$trailer.'').'" rel="modal" data-modal-type="'.$film.'"><i class="fa fa-youtube-play"></i><span>'.trailer.'</span></a></li>';
		} 
	}
