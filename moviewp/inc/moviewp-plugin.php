 ...
 * @subpackage Example
 * @version    2.6.1 for parent theme Moviewp
...
function moviewp_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => 'https://github.com/VincenzoPiromalli/moviewp/blob/main/plugins/custom-post-template.zip?raw=true', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => 'https://github.com/VincenzoPiromalli/moviewp/blob/main/plugins/advanced-custom-fields-pro.zip?raw=true', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => 'https://github.com/VincenzoPiromalli/moviewp/blob/main/plugins/Importer.zip?raw=true', // The plugin source.
