...
<div class="moviewppanel-column">
	...
	<div class="moviewppanel-box">
		...
		<p>
			...
			<span class="helptext"><?php echo __('Enter OMDB TMDB API key, you can get it for free', 'moviewp'); ?>&nbsp;<a href="<?php echo esc_url( __( 'https://anon.to/?http://www.omdbapi.com/apikey.aspx', 'moviewp' ) ); ?>" target="_blank" rel="nofollow"><?php printf( __( 'here %s', 'moviewp' ),''); ?></a><br><?php echo __('This API key is needed to get the tv series country as the TMDB API does not support the function.', 'moviewp'); ?><br><?php echo __('Default:', 'moviewp'); ?> <?php echo __('128fb1d4', 'moviewp'); ?></span>
		...
		<!--<p>
			<label for="moviewppanel_email"><?php echo __('Email', 'moviewp'); ?></label>
			<span class="helptext"><?php echo __('Insert our email for contact DMCA page', 'moviewp'); ?><br><?php echo __('Default:', 'moviewp'); ?> <?php echo __('johndoe@gmail.com', 'moviewp'); ?></span>
			<input type="text" placeholder="<?php echo __('johndoe@gmail.com', 'moviewp'); ?>" name="moviewppanel_email" id="moviewppanel_email"  value="<?php echo stripslashes_deep(get_option('moviewppanel_email')); ?>">
		</p>-->
